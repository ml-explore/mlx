...
class TestConstants(mlx_tests.MLXTestCase):
    def test_constants_values(self):
        ...
        self.assertAlmostEqual(mx.e, 2.71828182845904523536028747135266249775724709369995)
        self.assertAlmostEqual(mx.euler_gamma, 0.5772156649015328606065120900824024310421)
        self.assertAlmostEqual(mx.inf, float('inf'))
