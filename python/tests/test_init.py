...
class TestInit(mlx_tests.MLXTestCase):
    ...
    def test_orthogonal(self):
        ...
        self.assertTrue(mx.allclose(I, eye, atol=1e-5), "Orthogonal init failed on a square matrix.")
        ...
        self.assertTrue(mx.allclose(I, eye, atol=1e-5), "Orthogonal init failed on a rectangular matrix.")
