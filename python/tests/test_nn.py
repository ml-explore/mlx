...
class TestLayers(mlx_tests.MLXTestCase):
    ...
    def test_gelu(self):
        ...
        out_tanh = nn.GELU(approx="tanh")(mx.array(inputs))
        self.assertTrue(np.allclose(out_tanh, expected_tanh))
