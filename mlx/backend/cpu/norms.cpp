...
// RMS Norm for fp16/bf16 - load as float via SIMD, compute in float32, and
// convert back.
template <typename T>
...
// Layer Norm for fp16/bf16 - load as float via SIMD, compute in float32, and
// convert back.
template <typename T>
