...
#define instantiate_cross_entropy(name, itype)                                    \
  instantiate_kernel("block_cross_entropy_" #name, cross_entropy, itype)          \
  instantiate_kernel("looped_cross_entropy_" #name, cross_entropy_looped, itype)  \
  instantiate_kernel("vjp_cross_entropy_" #name, cross_entropy_vjp, itype)        \
