...
#define instantiate_copy_itype(itname, itype)                                  \
  instantiate_copy_all(itname##bool_, itype, bool) instantiate_copy_all(       \
      itname##uint8,                                                           \
      itype,                                                                   \
      uint8_t) instantiate_copy_all(itname##uint16, itype, uint16_t)           \
                      ...
                      instantiate_copy_all(itname##int32, itype, int32_t)      \
                          instantiate_copy_all(itname##int64, itype, int64_t)  \
                              instantiate_copy_all(                            \
                                  itname##float16, itype, half)                \
                                  instantiate_copy_all(                        \
                                      itname##float32, itype, float)           \
                                      instantiate_copy_all(                    \
                                          itname##bfloat16, itype, bfloat16_t) \
                                          instantiate_copy_all(                \
                                              itname##complex64,               \
                                              itype,                           \
                                              complex64_t)

instantiate_copy_itype(bool_, bool) instantiate_copy_itype(uint8, uint8_t)
    instantiate_copy_itype(uint16, uint16_t) instantiate_copy_itype(
        uint32,
        uint32_t) instantiate_copy_itype(uint64, uint64_t)
        instantiate_copy_itype(int8, int8_t) instantiate_copy_itype(
            int16,
            int16_t) instantiate_copy_itype(int32, int32_t)
