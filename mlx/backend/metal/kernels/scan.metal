...
#define instantiate_scan_helper(name, itype, otype, op, nreads)                \
  instantiate_contiguous_scan(                                                 \
      inclusive_##name, itype, otype, op, true, false, nreads)                 \
      instantiate_contiguous_scan(                                             \
          exclusive_##name, itype, otype, op, false, false, nreads)            \
          instantiate_contiguous_scan(                                         \
              reverse_inclusive_##name, itype, otype, op, true, true, nreads)  \
              instantiate_contiguous_scan(                                     \
                  reverse_exclusive_##name,                                    \
                  itype,                                                       \
                  otype,                                                       \
                  op,                                                          \
                  false,                                                       \
...
instantiate_scan_helper(
    ...
    int32_t,
    CumSum,
    4) instantiate_scan_helper(sum_uint8_uint8, uint8_t, uint8_t, CumSum, 4)
    instantiate_scan_helper(sum_uint16_uint16, uint16_t, uint16_t, CumSum, 4)
        instantiate_scan_helper(
            ...
            CumSum,
            4)
    // instantiate_scan_helper(sum_uint64_uint64,       uint64_t,    uint64_t,
    // CumSum, 2)
    instantiate_scan_helper(
        sum_int8_int8,
        int8_t,
        int8_t,
        CumSum,
        4) instantiate_scan_helper(sum_int16_int16, int16_t, int16_t, CumSum, 4)
        instantiate_scan_helper(sum_int32_int32, int32_t, int32_t, CumSum, 4)
    // instantiate_scan_helper(sum_int64_int64,         int64_t,     int64_t,
    // CumSum, 2)
    ...
    // instantiate_scan_helper(sum_bfloat16_bfloat16,   bfloat16_t,  bfloat16_t,
    // CumSum, 4) instantiate_scan_helper(sum_complex64_complex64, complex64_t,
    // complex64_t, CumSum) instantiate_scan_helper(prod_bool__bool_, bool,
    // bool,        CumProd, 4)
    instantiate_scan_helper(prod_uint8_uint8, uint8_t, uint8_t, CumProd, 4)
        instantiate_scan_helper(
            ...
            instantiate_scan_helper(
                ...
                CumProd,
                4)
    // instantiate_scan_helper(prod_uint64_uint64,       uint64_t,    uint64_t,
    // CumProd, 2)
    instantiate_scan_helper(prod_int8_int8, int8_t, int8_t, CumProd, 4)
        instantiate_scan_helper(prod_int16_int16, int16_t, int16_t, CumProd, 4)
            instantiate_scan_helper(
                ...
                CumProd,
                4)
    // instantiate_scan_helper(prod_int64_int64,         int64_t,     int64_t,
    // CumProd, 2)
    ...
    // instantiate_scan_helper(prod_bfloat16_bfloat16,   bfloat16_t, bfloat16_t,
    // CumProd, 4) instantiate_scan_helper(prod_complex64_complex64,
    // complex64_t, complex64_t, CumProd)
    // instantiate_scan_helper(max_bool__bool_,         bool,        bool,
    // CumMax, 4)
    instantiate_scan_helper(max_uint8_uint8, uint8_t, uint8_t, CumMax, 4)
        instantiate_scan_helper(
            ...
            instantiate_scan_helper(
                ...
                CumMax,
                4)
    // instantiate_scan_helper(max_uint64_uint64,       uint64_t,    uint64_t,
    // CumMax, 2)
    instantiate_scan_helper(
        max_int8_int8,
        int8_t,
        int8_t,
        CumMax,
        4) instantiate_scan_helper(max_int16_int16, int16_t, int16_t, CumMax, 4)
        instantiate_scan_helper(max_int32_int32, int32_t, int32_t, CumMax, 4)
    // instantiate_scan_helper(max_int64_int64,         int64_t,     int64_t,
    // CumMax, 2)
    ...
    // instantiate_scan_helper(max_bfloat16_bfloat16,   bfloat16_t,  bfloat16_t,
    // CumMax, 4) instantiate_scan_helper(max_complex64_complex64, complex64_t,
    // complex64_t, CumMax) instantiate_scan_helper(min_bool__bool_, bool, bool,
    // CumMin, 4)
    instantiate_scan_helper(min_uint8_uint8, uint8_t, uint8_t, CumMin, 4)
        instantiate_scan_helper(
            ...
            instantiate_scan_helper(
                ...
                CumMin,
                4)
    // instantiate_scan_helper(min_uint64_uint64,       uint64_t,    uint64_t,
    // CumMin, 2)
    instantiate_scan_helper(
        min_int8_int8,
        int8_t,
        int8_t,
        CumMin,
        4) instantiate_scan_helper(min_int16_int16, int16_t, int16_t, CumMin, 4)
        instantiate_scan_helper(min_int32_int32, int32_t, int32_t, CumMin, 4)
    // instantiate_scan_helper(min_int64_int64,         int64_t,     int64_t,
    // CumMin, 2)
    ...
    // instantiate_scan_helper(min_bfloat16_bfloat16,   bfloat16_t,  bfloat16_t,
    // CumMin, 4) instantiate_scan_helper(min_complex64_complex64, complex64_t,
    // complex64_t, CumMin)
