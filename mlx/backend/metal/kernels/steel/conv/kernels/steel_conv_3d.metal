...
#define instantiate_implicit_conv_3d(                                          \
  ...
  implicit_gemm_conv_3d<itype, bm, bn, bk, wm, wn>(                            \
...
#define instantiate_implicit_3d_blocks(name, itype)                \
    instantiate_implicit_conv_3d(name, itype, 32,  8, 16, 4, 1)    \
    instantiate_implicit_conv_3d(name, itype, 64,  8, 16, 4, 1)    \
    instantiate_implicit_conv_3d(name, itype, 32, 32, 16, 2, 2)    \
    instantiate_implicit_conv_3d(name, itype, 32, 64, 16, 2, 2)    \
    instantiate_implicit_conv_3d(name, itype, 64, 32, 16, 2, 2)    \
    instantiate_implicit_conv_3d(name, itype, 64, 64, 16, 2, 2)
