...
struct AttnParams {
  ...
  int64_t LSE_strides[2]; ///< LSE strides (B*H, L) - logsumexp output buffer for VJP
};
...
///////////////////////////////////////////////////////////////////////////////
// VJP Parameters - extends AttnParams with gradient strides
///////////////////////////////////////////////////////////////////////////////
...
struct AttnVJPParams {
  ...
  int64_t LSE_strides[2];     ///< LSE strides (B*H, L)
};
