...
[[kernel, max_total_threads_per_threadgroup(WM* WN * 32)]] void gemm(
  ...
  gemm_kernel::run(
      A, B, C, params, As, Bs, simd_lane_id, simd_group_id, tid, lid);
}
...
#define instantiate_gemm_aligned_helper(tname, trans_a, trans_b, iname, itype, oname, otype, bm, bn, bk, wm, wn)             \
  ...
  instantiate_gemm(tname, trans_a, trans_b, iname, itype, oname, otype, bm, bn, bk, wm, wn, naligned, false, naligned, false) // clang-format off
