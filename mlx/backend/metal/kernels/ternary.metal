...
#define instantiate_ternary_types(name, op)                                   \
  instantiate_ternary_all(name, bool_, bool, op) instantiate_ternary_all(     \
                  ...
                  instantiate_ternary_all(name, int8, int8_t, op)             \
                      instantiate_ternary_all(name, int16, int16_t, op)       \
                          instantiate_ternary_all(name, int32, int32_t, op)   \
                              instantiate_ternary_all(                        \
                                  name, int64, int64_t, op)                   \
                                  instantiate_ternary_all(                    \
                                      name, float16, half, op)                \
                                      instantiate_ternary_all(                \
                                          name, float32, float, op)           \
                                          instantiate_ternary_all(            \
                                              name, bfloat16, bfloat16_t, op) \
                                              instantiate_ternary_all(        \
                                                  name,                       \
                                                  complex64,                  \
                                                  complex64_t,                \
