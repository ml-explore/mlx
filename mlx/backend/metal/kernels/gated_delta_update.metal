...
#define instantiate_gated_delta_update_seq(in_type, st_type, dk, dv, hk, hv)  \
  instantiate_kernel(                                                        \
      "seq_gated_delta_" #in_type "_" #st_type "_" #dk "_" #dv "_" #hk "_" #hv, \
      gated_delta_seq,                                                      \
      in_type,                                                               \
      st_type,                                                               \
      dk,                                                                    \
...
#define instantiate_gated_delta_update_chunk(in_type, st_type, dk, dv, hk, hv, c)  \
  instantiate_kernel(                                                        \
      "chunk_gated_delta_" #in_type "_" #st_type "_" #dk "_" #dv "_" #hk "_" #hv "_" #c, \
      gated_delta_chunk,                                                      \
      in_type,                                                               \
      st_type,                                                               \
      dk,                                                                    \
