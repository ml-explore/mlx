...
[[kernel]] void all_reduce_no_atomics(
  ...
  // Write out thread group reduction result
  if (lid == 0) {
...
///////////////////////////////////////////////////////////////////////////////
// Column reduce without atomics
///////////////////////////////////////////////////////////////////////////////

template <typename T, typename U, typename Op, int N_READS = REDUCE_N_READS>
inline void _contiguous_strided_reduce_no_atomics(
    const device T *in,
    device U *out,
  ...
  if (lid.y == 0) {
    out[tgsize_y * tgsize_z * gid_x + tgsize_y * tid.z + tid.y] = val;
  }
}
...
[[kernel]] void col_reduce_general_no_atomics(
  ...
  if(out_idx < out_size) {
    _contiguous_strided_reduce_no_atomics<T, U, Op, N_READS>(
      in,
      out,
      local_data,
      in_idx,
