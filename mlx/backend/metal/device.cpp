...
Device& device(mlx::core::Device) {
  // Leak singleton device intentionally, to avoid cases where a compute kernel returns and
  // tries to access the object after it has been freed by the main thread teardown.
