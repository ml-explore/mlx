...
class BenchmarkSummary:
    ...
    def print_summary(self):
        ...
        for op, results in ops.items():
            ...
            # Print header
            print(f"{'Algorithm':<20} {'Size (MB)':>12} {'Latency (ms)':>14} "
            ...
            for r in results:
                ...
                print(f"{r.algo:<20} {size_mb:>12.2f} {r.latency_ms:>14.5f} "
    ...
    for algo in algorithms:
        ...
        for size in sizes:
            ...
            try:
                ...
                bandwidth = (size_bytes * num_processes) / (mean_time / 1000) / (1024**3)
    ...
    for algo in algorithms:
        ...
        for size in sizes:
            ...
            try:
                ...
                bandwidth = (send_bytes * num_processes) / (mean_time / 1000) / (1024**3)
                ops_per_sec = 1000 / mean_time
...
def benchmark_pipeline_overhead(
    ...
    for size in sizes:
        ...
        try:
            ...
            print(f"  Size {size/1024:.2f}K ({num_stages} stages): "
    ...
    if args.full:
        ...
        for op, sizes in ops.items():
            ...
            for size, result in sorted(sizes.items(), key=lambda x: x[0]):
                ...
                speedup = result.bandwidth_gbps / 5.0 if result.bandwidth_gbps > 0 else result.operations_per_sec / 100
                print(f"  {size_mb:.2f}MB: {result.algo} ({result.bandwidth_gbps:.2f} GB/s)")
