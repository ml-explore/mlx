...
TEST_CASE("test tile") {
  ...
  auto expected_1 = array(
      {6., 10., 6., 10., 6., 10., 1., 3., 1., 3., 1., 3.,
       9., 5.,  9., 5.,  9., 5.,  9., 2., 9., 2., 9., 2.,
       5., 3.,  5., 3.,  5., 3.,  3., 4., 3., 4., 3., 4.},
      {3, 2, 6});

  auto tiled_1 = tile(data, {3});

  auto data_2 =
      array({4., 4., 9., 7., 7., 3., 6., 8., 8., 3., 8., 7.}, {3, 2, 2});

  auto expected_2 = array(
      {4., 4., 4., 4., 9., 7., 9., 7., 4., 4., 4., 4., 9., 7., 9., 7., 4., 4.,
       4., 4., 9., 7., 9., 7., 7., 3., 7., 3., 6., 8., 6., 8., 7., 3., 7., 3.,
       6., 8., 6., 8., 7., 3., 7., 3., 6., 8., 6., 8., 8., 3., 8., 3., 8., 7.,
       8., 7., 8., 3., 8., 3., 8., 7., 8., 7., 8., 3., 8., 3., 8., 7., 8., 7.},
      {3, 6, 4});

  auto tiled_2 = tile(data_2, {3, 2});

  auto expected_3 = array(
      {4., 4., 4., 4., 9., 7., 9., 7., 4., 4., 4., 4., 9., 7., 9., 7., 7., 3.,
       7., 3., 6., 8., 6., 8., 7., 3., 7., 3., 6., 8., 6., 8., 8., 3., 8., 3.,
       8., 7., 8., 7., 8., 3., 8., 3., 8., 7., 8., 7., 4., 4., 4., 4., 9., 7.,
       9., 7., 4., 4., 4., 4., 9., 7., 9., 7., 7., 3., 7., 3., 6., 8., 6., 8.,
       7., 3., 7., 3., 6., 8., 6., 8., 8., 3., 8., 3., 8., 7., 8., 7., 8., 3.,
       8., 3., 8., 7., 8., 7., 4., 4., 4., 4., 9., 7., 9., 7., 4., 4., 4., 4.,
       9., 7., 9., 7., 7., 3., 7., 3., 6., 8., 6., 8., 7., 3., 7., 3., 6., 8.,
       6., 8., 8., 3., 8., 3., 8., 7., 8., 7., 8., 3., 8., 3., 8., 7., 8., 7.},
      {9, 4, 4});

  auto tiled_3 = tile(data_2, {3, 2, 2});
  ...
  auto tiled_4 = tile(data_2, {3, 2, 2, 2});

  auto expected_5 =
      array({4., 4., 9., 7., 7., 3., 6., 8., 8., 3., 8., 7.}, {3, 2, 2});
  auto tiled_5 = tile(data_2, {1, 1, 1});

  auto expected_6 =
      array({4., 4., 9., 7., 7., 3., 6., 8., 8., 3., 8., 7.}, {1, 3, 2, 2});
  auto tiled_6 = tile(data_2, {1, 1, 1, 1});

  CHECK(array_equal(expected_1, tiled_1).item<bool>());
  CHECK(array_equal(expected_2, tiled_2).item<bool>());
  CHECK(array_equal({expected_3}, {tiled_3}).item<bool>());
  CHECK(array_equal({expected_4}, {tiled_4}).item<bool>());
  CHECK(array_equal({expected_5}, {tiled_5}).item<bool>());
